...
print("----------MENU----------")
print("1) Display Course Information") #working
print("2) Lookup Course") #working
print("3) Display Courses and Tuition for Specific Students") # working
print("4) Display Tuition for All Students")
print("5) Display # of Students and Tuition for All Courses") #working
print("6) EXIT") #working
print("------------------------")
...
while choice != EXIT:
    ...
    #displays tuition for all students 
        ...
        '''
        #Initialize a dictionary to store the number of students in each course
        course_enrollment = {course: 0 for course in courses.keys()}
        #Initialize a list to store the student information
        student_tuitions = [] 
        #Iterate over each student and their courses
        for student, courses_taken in students.items():
            # Initialize the total tuition cost for the student
            tuition_cost = 0
            ...
            for course in courses_taken:
                ...
                # Add the tuition cost of the course to the student's total
                tuition_cost += courses[course]
                    
                # Append the student's information to the list
                student_tuitions.append({"Student": student, "Number of Courses": len(courses_taken), "Total Tuition": tuition_cost})
            
            # Calculate the overall tuition cost
            total_tuition = sum([s["Total Tuition"] for s in student_tuitions])
            
            # Print the student information in a table
            print(f"{'Student':<20}{'Number of Courses':<20}{'Total Tuition':<20}")
            for s in student_tuitions:
                print(f"{s['Student']:<20}{s['Number of Courses']:<20}{s['Total Tuition']:.2f:<20}")
            
            # Print the overall tuition cost
            print(f"{'Total':<20}{'':<20}{total_tuition:.2f}")
            
            # Print the course enrollment information
            print("\nCourse Enrollment:")
            print(f"{'Course':<10}{'Enrollment':<10}")
